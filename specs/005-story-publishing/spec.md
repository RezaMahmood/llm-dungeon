...
- An administrator attempts to publish a story that has never been test-played, or whose content changed since its last test play: the publish action is blocked (see `010-story-test-play`), and the administrator sees explanatory text stating why — whether the attempt was made from the wizard or from the story list.
