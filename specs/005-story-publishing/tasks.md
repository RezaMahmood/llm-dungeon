...
- [X] T018 Final acceptance: request the user/product owner verify the publish/unpublish flow (wizard's "Publish & assign" step) against the deployed or locally running environment, per Constitution Principle IX — do not mark this feature done without that explicit sign-off.
