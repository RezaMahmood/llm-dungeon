...
- [X] T017 Walk through quickstart.md Scenarios 1-3 and 5 manually against a local run (Scenario 4 depends on `008-core-gameplay-done`/`009-save-and-continue` and is out of scope until those exist — note this explicitly rather than skipping silently); confirm SC-001, SC-002, and SC-004 hold.
