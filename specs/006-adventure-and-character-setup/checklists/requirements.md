...
- Depends on `005-story-publishing-done` (adventure list) and `004-story-creation-done`/`011-story-import`
  (character type definitions); hands off to `008-core-gameplay-done`.
