...
- Menu item labels and administration-page contents beyond "leads to the administration page" are out of scope for this feature and are defined by the features that build those destinations (see `005-story-publishing-done`, `012-story-editing-and-review`, and related specs).
